...
pwsh tools/windows-reference/reference.ps1 -Action generate-arc-matrix -Path fixtures/real-world
pwsh tools/windows-reference/reference.ps1 -Action generate-emfplus-only -Path fixtures/real-world
...
WMF bytes emitted by GDI. The generator also creates project-owned EMF and
EMF+ Only/Dual samples through GDI+ for future-format classification coverage.
